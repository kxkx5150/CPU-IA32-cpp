...
uint16_t CPU::shift16RightJamming(uint16_t a, int count)
{
    uint16_t z;
    if (count == 0) {
        z = a;
...
uint32_t CPU::shift32RightJamming(uint32_t a, int count)
{
    uint32_t z;
    if (count == 0) {
        z = a;
...
uint64_t CPU::shift64RightJamming(uint64_t a, int count)
{
    uint64_t z;
    if (count == 0) {
        z = a;
...
void CPU::shift64ExtraRightJamming(uint64_t a0, uint64_t a1, int count, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    uint64_t z0, z1;
...
void CPU::add128(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    uint64_t z1 = a1 + b1;
    *z1Ptr      = z1;
    *z0Ptr      = a0 + b0 + (z1 < a1);
}
void CPU::sub128(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    *z1Ptr = a1 - b1;
    *z0Ptr = a0 - b0 - (a1 < b1);
}
void CPU::mul64To128(uint64_t a, uint64_t b, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
...
uint64_t CPU::estimateDiv128To64(uint64_t a0, uint64_t a1, uint64_t b)
{
    uint64_t b0, b1;
...
uint32_t CPU::estimateSqrt32(int16_t aExp, uint32_t a)
{
...
int CPU::countLeadingZeros16(uint16_t a)
{
    int shiftCount = 0;
    if (a < 0x100) {
        shiftCount += 8;
...
int CPU::countLeadingZeros32(uint32_t a)
{
    int shiftCount = 0;
    if (a < 0x10000) {
        shiftCount += 16;
...
int CPU::countLeadingZeros64(uint64_t a)
{
    int shiftCount = 0;
    if (a < (uint64_t)0x100000000ULL) {
        shiftCount += 32;
    } else {
        a >>= 32;
    }
...
void CPU::shift128Right(uint64_t a0, uint64_t a1, int count, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    uint64_t z0, z1;
    int      negCount = (-count) & 63;
    if (count == 0) {
...
void CPU::shift128RightJamming(uint64_t a0, uint64_t a1, int count, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    uint64_t z0, z1;
    int      negCount = (-count) & 63;
    if (count == 0) {
...
void CPU::shortShift128Left(uint64_t a0, uint64_t a1, int count, uint64_t *z0Ptr, uint64_t *z1Ptr)
{
    *z1Ptr = a1 << count;
    *z0Ptr = (count == 0) ? a0 : (a0 << count) | (a1 >> ((-count) & 63));
}
void CPU::add192(uint64_t a0, uint64_t a1, uint64_t a2, uint64_t b0, uint64_t b1, uint64_t b2, uint64_t *z0Ptr,
...
void CPU::sub192(uint64_t a0, uint64_t a1, uint64_t a2, uint64_t b0, uint64_t b1, uint64_t b2, uint64_t *z0Ptr,
                 uint64_t *z1Ptr, uint64_t *z2Ptr)
{
    uint64_t z0, z1, z2;
...
int CPU::eq128(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1)
{
    return (a0 == b0) && (a1 == b1);
}
int CPU::le128(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1)
{
    return (a0 < b0) || ((a0 == b0) && (a1 <= b1));
}
int CPU::lt128(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1)
{
    return (a0 < b0) || ((a0 == b0) && (a1 < b1));
}
void CPU::mul128By64To192(uint64_t a0, uint64_t a1, uint64_t b, uint64_t *z0Ptr, uint64_t *z1Ptr, uint64_t *z2Ptr)
{
...
void CPU::mul128To256(uint64_t a0, uint64_t a1, uint64_t b0, uint64_t b1, uint64_t *z0Ptr, uint64_t *z1Ptr,
...
void CPU::shift128ExtraRightJamming(uint64_t a0, uint64_t a1, uint64_t a2, int count, uint64_t *z0Ptr, uint64_t *z1Ptr,
                                    uint64_t *z2Ptr)
{
    uint64_t z0, z1, z2;
    int      negCount = (-count) & 63;
...
uint16_t CPU::extractFloat16Frac(float16 a)
{
    return a & 0x3FF;
}
int16_t CPU::extractFloat16Exp(float16 a)
{
    return (a >> 10) & 0x1F;
}
int CPU::extractFloat16Sign(float16 a)
{
    return a >> 15;
}
float16 CPU::packFloat16(int zSign, int zExp, uint16_t zSig)
{
    return (((uint16_t)zSign) << 15) + (((uint16_t)zExp) << 10) + zSig;
}
int CPU::float16_is_nan(float16 a)
{
    return (0xF800 < (uint16_t)(a << 1));
}
int CPU::float16_is_signaling_nan(float16 a)
{
    return (((a >> 9) & 0x3F) == 0x3E) && (a & 0x1FF);
}
int CPU::float16_is_denormal(float16 a)
{
    return (extractFloat16Exp(a) == 0) && (extractFloat16Frac(a) != 0);
}
float16 CPU::float16_denormal_to_zero(float16 a)
{
    if (float16_is_denormal(a))
        a &= 0x8000;
    return a;
}
CPU::commonNaNT CPU::float16ToCommonNaN(float16 a, float_status_t *status)
{
    CPU::commonNaNT z;
...
float16 CPU::commonNaNToFloat16(CPU::commonNaNT a)
{
    return (((uint16_t)a.sign) << 15) | 0x7E00 | (uint16_t)(a.hi >> 54);
}
uint32_t CPU::extractFloat32Frac(float32 a)
{
    return a & 0x007FFFFF;
}
int16_t CPU::extractFloat32Exp(float32 a)
{
    return (a >> 23) & 0xFF;
}
int CPU::extractFloat32Sign(float32 a)
{
    return a >> 31;
}
float32 CPU::packFloat32(int zSign, int16_t zExp, uint32_t zSig)
{
    return (((uint32_t)zSign) << 31) + (((uint32_t)zExp) << 23) + zSig;
}
int CPU::float32_is_nan(float32 a)
{
    return (0xFF000000 < (uint32_t)(a << 1));
}
int CPU::float32_is_signaling_nan(float32 a)
{
    return (((a >> 22) & 0x1FF) == 0x1FE) && (a & 0x003FFFFF);
}
int CPU::float32_is_denormal(float32 a)
{
    return (extractFloat32Exp(a) == 0) && (extractFloat32Frac(a) != 0);
}
float32 CPU::float32_denormal_to_zero(float32 a)
{
    if (float32_is_denormal(a))
        a &= 0x80000000;
    return a;
}
CPU::commonNaNT CPU::float32ToCommonNaN(float32 a, float_status_t *status)
{
    CPU::commonNaNT z;
...
float32 CPU::commonNaNToFloat32(CPU::commonNaNT a)
{
    return (((uint32_t)a.sign) << 31) | 0x7FC00000 | (uint32_t)(a.hi >> 41);
}
float32 CPU::propagateFloat32NaN(float32 a, float_status_t *status)
{
    if (float32_is_signaling_nan(a))
        float_raise(status, float_flag_invalid);
    return a | 0x00400000;
}
uint64_t CPU::extractFloat64Frac(float64 a)
{
    return a & 0x000FFFFFFFFFFFFFULL;
}
int16_t CPU::extractFloat64Exp(float64 a)
{
    return (int16_t)(a >> 52) & 0x7FF;
}
int CPU::extractFloat64Sign(float64 a)
{
    return (int)(a >> 63);
}
float64 CPU::packFloat64(int zSign, int16_t zExp, uint64_t zSig)
{
    return (((uint64_t)zSign) << 63) + (((uint64_t)zExp) << 52) + zSig;
}
int CPU::float64_is_nan(float64 a)
{
    return (0xFFE0000000000000ULL < (uint64_t)(a << 1));
}
int CPU::float64_is_signaling_nan(float64 a)
{
    return (((a >> 51) & 0xFFF) == 0xFFE) && (a & 0x0007FFFFFFFFFFFFULL);
}
int CPU::float64_is_denormal(float64 a)
{
    return (extractFloat64Exp(a) == 0) && (extractFloat64Frac(a) != 0);
}
float64 CPU::float64_denormal_to_zero(float64 a)
{
    if (float64_is_denormal(a))
        a &= ((uint64_t)(1) << 63);
    return a;
}
CPU::commonNaNT CPU::float64ToCommonNaN(float64 a, float_status_t *status)
{
    CPU::commonNaNT z;
...
float64 CPU::commonNaNToFloat64(CPU::commonNaNT a)
{
    return (((uint64_t)a.sign) << 63) | 0x7FF8000000000000ULL | (a.hi >> 12);
}
float64 CPU::propagateFloat64NaN(float64 a, float_status_t *status)
{
    if (float64_is_signaling_nan(a))
        float_raise(status, float_flag_invalid);
    return a | 0x0008000000000000ULL;
}
uint64_t CPU::extractFloatx80Frac(floatx80 a)
{
    return a.fraction;
}
int32_t CPU::extractFloatx80Exp(floatx80 a)
{
    return a.exp & 0x7FFF;
}
int CPU::extractFloatx80Sign(floatx80 a)
{
    return a.exp >> 15;
}
floatx80 CPU::packFloatx80(int zSign, int32_t zExp, uint64_t zSig)
{
    floatx80 z;
    z.fraction = zSig;
    z.exp      = (zSign << 15) + zExp;
...
int CPU::floatx80_is_nan(floatx80 a)
{
    return ((a.exp & 0x7FFF) == 0x7FFF) && (int64_t)(a.fraction << 1);
}
int CPU::floatx80_is_signaling_nan(floatx80 a)
{
    uint64_t aLow = a.fraction & ~0x4000000000000000ULL;
    return ((a.exp & 0x7FFF) == 0x7FFF) && ((uint64_t)(aLow << 1)) && (a.fraction == aLow);
}
int CPU::floatx80_is_unsupported(floatx80 a)
{
    return ((a.exp & 0x7FFF) && !(a.fraction & 0x8000000000000000ULL));
}
CPU::commonNaNT CPU::floatx80ToCommonNaN(floatx80 a, float_status_t *status)
{
    CPU::commonNaNT z;
...
floatx80 CPU::commonNaNToFloatx80(CPU::commonNaNT a)
{
    floatx80 z;
...
floatx80 CPU::propagateFloatx80NaN(floatx80 a, float_status_t *status)
{
    if (floatx80_is_signaling_nan(a))
        float_raise(status, float_flag_invalid);
...
uint64_t CPU::extractFloat128Frac1(float128 a)
{
    return a.lo;
}
uint64_t CPU::extractFloat128Frac0(float128 a)
{
    return a.hi & 0x0000FFFFFFFFFFFFULL;
}
int32_t CPU::extractFloat128Exp(float128 a)
{
    return ((int32_t)(a.hi >> 48)) & 0x7FFF;
}
int CPU::extractFloat128Sign(float128 a)
{
    return (int)(a.hi >> 63);
}
float128 CPU::packFloat128(int zSign, int32_t zExp, uint64_t zSig0, uint64_t zSig1)
{
    float128 z;
    z.lo = zSig1;
...
float128 CPU::packFloat128_simple(uint64_t zHi, uint64_t zLo)
{
    float128 z;
    z.lo = zLo;
    z.hi = zHi;
...
int CPU::float128_is_nan(float128 a)
{
    return (0xFFFE000000000000ULL <= (uint64_t)(a.hi << 1)) && (a.lo || (a.hi & 0x0000FFFFFFFFFFFFULL));
}
int CPU::float128_is_signaling_nan(float128 a)
{
    return (((a.hi >> 47) & 0xFFFF) == 0xFFFE) && (a.lo || (a.hi & 0x00007FFFFFFFFFFFULL));
}
CPU::commonNaNT CPU::float128ToCommonNaN(float128 a, float_status_t *status)
{
    CPU::commonNaNT z;
...
float128 CPU::commonNaNToFloat128(CPU::commonNaNT a)
{
    float128 z;
    shift128Right(a.hi, a.lo, 16, &z.hi, &z.lo);
    z.hi |= (((uint64_t)a.sign) << 63) | 0x7FFF800000000000ULL;
    return z;
}
float32 CPU::int32_to_float32(int32_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
...
float64 CPU::int32_to_float64(int32_t a)
{
    if (a == 0)
        return 0;
    int      zSign      = (a < 0);
...
float32 CPU::int64_to_float32(int64_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
    int      zSign      = (a < 0);
...
float64 CPU::int64_to_float64(int64_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
...
float32 CPU::uint32_to_float32(uint32_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
    if (a & 0x80000000)
...
float64 CPU::uint32_to_float64(uint32_t a)
{
    if (a == 0)
        return 0;
...
float32 CPU::uint64_to_float32(uint64_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
...
float64 CPU::uint64_to_float64(uint64_t a, float_status_t *status)
{
    if (a == 0)
        return 0;
...
int32_t CPU::float32_to_int32(float32 a, float_status_t *status)
{
...
int32_t CPU::float32_to_int32_round_to_zero(float32 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint32_t aSig;
...
uint32_t CPU::float32_to_uint32_round_to_zero(float32 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint32_t aSig;
...
int64_t CPU::float32_to_int64(float32 a, float_status_t *status)
{
...
int64_t CPU::float32_to_int64_round_to_zero(float32 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint32_t aSig;
...
uint64_t CPU::float32_to_uint64_round_to_zero(float32 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint32_t aSig;
...
uint64_t CPU::float32_to_uint64(float32 a, float_status_t *status)
{
    int      aSign;
...
uint32_t CPU::float32_to_uint32(float32 a, float_status_t *status)
{
...
float64 CPU::float32_to_float64(float32 a, float_status_t *status)
{
    uint32_t aSig  = extractFloat32Frac(a);
    int16_t  aExp  = extractFloat32Exp(a);
    int      aSign = extractFloat32Sign(a);
    if (aExp == 0xFF) {
        if (aSig)
            return CPU::commonNaNToFloat64(float32ToCommonNaN(a, status));
...
float32 CPU::float32_round_to_int_with_scale(float32 a, uint8_t scale, float_status_t *status)
{
...
float32 CPU::float32_frc(float32 a, float_status_t *status)
{
    int      roundingMode = get_float_rounding_mode(status);
    int16_t  aExp         = extractFloat32Exp(a);
    uint32_t aSig         = extractFloat32Frac(a);
...
float32 CPU::float32_getexp(float32 a, float_status_t *status)
{
    int16_t  aExp = extractFloat32Exp(a);
    uint32_t aSig = extractFloat32Frac(a);
    if (aExp == 0xFF) {
...
float32 CPU::float32_getmant(float32 a, float_status_t *status, int sign_ctrl, int interv)
{
    int16_t  aExp  = extractFloat32Exp(a);
    uint32_t aSig  = extractFloat32Frac(a);
    int      aSign = extractFloat32Sign(a);
...
float32 CPU::float32_scalef(float32 a, float32 b, float_status_t *status)
{
    uint32_t aSig  = extractFloat32Frac(a);
    int16_t  aExp  = extractFloat32Exp(a);
    int      aSign = extractFloat32Sign(a);
    ...
    if (bExp <= 0x7E) {
        ...
        if (bSign) {
            if ((uint32_t)(bSig << (shiftCount & 31)))
                scale++;
            scale = -scale;
        }
        if (scale > 0x200)
...
float32 CPU::addFloat32Sigs(float32 a, float32 b, int zSign, float_status_t *status)
{
...
float32 CPU::subFloat32Sigs(float32 a, float32 b, int zSign, float_status_t *status)
{
    int16_t  aExp, bExp, zExp;
    uint32_t aSig, bSig, zSig;
    int16_t  expDiff;
...
float32 CPU::float32_add(float32 a, float32 b, float_status_t *status)
{
    int aSign = extractFloat32Sign(a);
    int bSign = extractFloat32Sign(b);
    if (aSign == bSign) {
...
float32 CPU::float32_sub(float32 a, float32 b, float_status_t *status)
{
    int aSign = extractFloat32Sign(a);
    int bSign = extractFloat32Sign(b);
    if (aSign == bSign) {
...
float32 CPU::float32_mul(float32 a, float32 b, float_status_t *status)
{
...
float32 CPU::float32_div(float32 a, float32 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int16_t  aExp, bExp, zExp;
    uint32_t aSig, bSig, zSig;
...
float32 CPU::float32_sqrt(float32 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp, zExp;
    uint32_t aSig, zSig;
...
float_class_t CPU::float32_class(float32 a)
{
    int16_t  aExp  = extractFloat32Exp(a);
    uint32_t aSig  = extractFloat32Frac(a);
    int      aSign = extractFloat32Sign(a);
...
int CPU::float32_compare_internal(float32 a, float32 b, int quiet, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
...
float32 CPU::float32_min(float32 a, float32 b, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
        b = float32_denormal_to_zero(b);
...
float32 CPU::float32_max(float32 a, float32 b, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
        b = float32_denormal_to_zero(b);
...
float32 CPU::float32_minmax(float32 a, float32 b, int is_max, int is_abs, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
        b = float32_denormal_to_zero(b);
...
int32_t CPU::float64_to_int32(float64 a, float_status_t *status)
{
...
int32_t CPU::float64_to_int32_round_to_zero(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
...
uint32_t CPU::float64_to_uint32_round_to_zero(float64 a, float_status_t *status)
{
    uint64_t aSig  = extractFloat64Frac(a);
    int16_t  aExp  = extractFloat64Exp(a);
    int      aSign = extractFloat64Sign(a);
...
int64_t CPU::float64_to_int64(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
...
int64_t CPU::float64_to_int64_round_to_zero(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint64_t aSig;
...
uint64_t CPU::float64_to_uint64_round_to_zero(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint64_t aSig, z;
...
uint32_t CPU::float64_to_uint32(float64 a, float_status_t *status)
{
...
uint64_t CPU::float64_to_uint64(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp, shiftCount;
    uint64_t aSig, aSigExtra;
...
float32 CPU::float64_to_float32(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp;
    uint64_t aSig;
    ...
    if (aExp == 0x7FF) {
        if (aSig)
            return CPU::commonNaNToFloat32(float64ToCommonNaN(a, status));
        return packFloat32(aSign, 0xFF, 0);
    }
    if (aExp == 0) {
        if (aSig == 0 || get_denormals_are_zeros(status))
...
float64 CPU::float64_round_to_int_with_scale(float64 a, uint8_t scale, float_status_t *status)
{
...
float64 CPU::float64_frc(float64 a, float_status_t *status)
{
    int      roundingMode = get_float_rounding_mode(status);
    uint64_t aSig         = extractFloat64Frac(a);
    int16_t  aExp         = extractFloat64Exp(a);
    ...
    uint64_t lastBitMask   = 1ULL << (0x433 - aExp);
...
float64 CPU::float64_getexp(float64 a, float_status_t *status)
{
    int16_t  aExp = extractFloat64Exp(a);
    uint64_t aSig = extractFloat64Frac(a);
    if (aExp == 0x7FF) {
...
float64 CPU::float64_getmant(float64 a, float_status_t *status, int sign_ctrl, int interv)
{
    int16_t  aExp  = extractFloat64Exp(a);
    uint64_t aSig  = extractFloat64Frac(a);
    int      aSign = extractFloat64Sign(a);
...
float64 CPU::float64_scalef(float64 a, float64 b, float_status_t *status)
{
    uint64_t aSig  = extractFloat64Frac(a);
    int16_t  aExp  = extractFloat64Exp(a);
    int      aSign = extractFloat64Sign(a);
...
float64 CPU::addFloat64Sigs(float64 a, float64 b, int zSign, float_status_t *status)
{
    int16_t  aExp, bExp, zExp;
...
float64 CPU::subFloat64Sigs(float64 a, float64 b, int zSign, float_status_t *status)
{
    int16_t  aExp, bExp, zExp;
    uint64_t aSig, bSig, zSig;
    int16_t  expDiff;
...
float64 CPU::float64_add(float64 a, float64 b, float_status_t *status)
{
    int aSign = extractFloat64Sign(a);
    int bSign = extractFloat64Sign(b);
    if (aSign == bSign) {
...
float64 CPU::float64_sub(float64 a, float64 b, float_status_t *status)
{
    int aSign = extractFloat64Sign(a);
    int bSign = extractFloat64Sign(b);
    if (aSign == bSign) {
...
float64 CPU::float64_mul(float64 a, float64 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int16_t  aExp, bExp, zExp;
...
float64 CPU::float64_div(float64 a, float64 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int16_t  aExp, bExp, zExp;
    uint64_t aSig, bSig, zSig;
...
float64 CPU::float64_sqrt(float64 a, float_status_t *status)
{
    int      aSign;
    int16_t  aExp, zExp;
...
float_class_t CPU::float64_class(float64 a)
{
    int16_t  aExp  = extractFloat64Exp(a);
    uint64_t aSig  = extractFloat64Frac(a);
    int      aSign = extractFloat64Sign(a);
...
int CPU::float64_compare_internal(float64 a, float64 b, int quiet, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
...
float64 CPU::float64_min(float64 a, float64 b, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
        b = float64_denormal_to_zero(b);
...
float64 CPU::float64_max(float64 a, float64 b, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
        b = float64_denormal_to_zero(b);
...
float64 CPU::float64_minmax(float64 a, float64 b, int is_max, int is_abs, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
        b = float64_denormal_to_zero(b);
...
floatx80 CPU::int32_to_floatx80(int32_t a)
{
    if (a == 0)
...
floatx80 CPU::int64_to_floatx80(int64_t a)
{
    if (a == 0)
        return packFloatx80(0, 0, 0);
    int      zSign      = (a < 0);
...
floatx80 CPU::float32_to_floatx80(float32 a, float_status_t *status)
{
    uint32_t aSig  = extractFloat32Frac(a);
    int16_t  aExp  = extractFloat32Exp(a);
    int      aSign = extractFloat32Sign(a);
    if (aExp == 0xFF) {
        if (aSig)
            return CPU::commonNaNToFloatx80(float32ToCommonNaN(a, status));
...
floatx80 CPU::float64_to_floatx80(float64 a, float_status_t *status)
{
    uint64_t aSig  = extractFloat64Frac(a);
    int16_t  aExp  = extractFloat64Exp(a);
    int      aSign = extractFloat64Sign(a);
    if (aExp == 0x7FF) {
        if (aSig)
            return CPU::commonNaNToFloatx80(float64ToCommonNaN(a, status));
        return packFloatx80(aSign, 0x7FFF, 0x8000000000000000ULL);
    }
    if (aExp == 0) {
        if (aSig == 0)
...
int32_t CPU::floatx80_to_int32(floatx80 a, float_status_t *status)
{
...
int32_t CPU::floatx80_to_int32_round_to_zero(floatx80 a, float_status_t *status)
{
    int32_t  aExp;
    uint64_t aSig, savedASig;
    int32_t  z;
...
int64_t CPU::floatx80_to_int64(floatx80 a, float_status_t *status)
{
    int32_t  aExp;
    uint64_t aSig, aSigExtra;
    if (floatx80_is_unsupported(a)) {
...
int64_t CPU::floatx80_to_int64_round_to_zero(floatx80 a, float_status_t *status)
{
    int      aSign;
    int32_t  aExp;
    uint64_t aSig;
...
float32 CPU::floatx80_to_float32(floatx80 a, float_status_t *status)
{
    uint64_t aSig  = extractFloatx80Frac(a);
    int32_t  aExp  = extractFloatx80Exp(a);
    int      aSign = extractFloatx80Sign(a);
    ...
    if (aExp == 0x7FFF) {
        if ((uint64_t)(aSig << 1))
            return CPU::commonNaNToFloat32(floatx80ToCommonNaN(a, status));
        return packFloat32(aSign, 0xFF, 0);
    }
...
float64 CPU::floatx80_to_float64(floatx80 a, float_status_t *status)
{
    int32_t  aExp;
    uint64_t aSig, zSig;
    if (floatx80_is_unsupported(a)) {
    ...
    if (aExp == 0x7FFF) {
        if ((uint64_t)(aSig << 1)) {
            return CPU::commonNaNToFloat64(floatx80ToCommonNaN(a, status));
        }
        return packFloat64(aSign, 0x7FF, 0);
    }
...
floatx80 CPU::floatx80_round_to_int(floatx80 a, float_status_t *status)
{
    int      aSign;
    uint64_t lastBitMask, roundBitsMask;
    int      roundingMode = get_float_rounding_mode(status);
...
floatx80 CPU::addFloatx80Sigs(floatx80 a, floatx80 b, int zSign, float_status_t *status)
{
...
floatx80 CPU::subFloatx80Sigs(floatx80 a, floatx80 b, int zSign, float_status_t *status)
{
    int32_t  aExp, bExp, zExp;
    uint64_t aSig, bSig, zSig0, zSig1;
    if (floatx80_is_unsupported(a) || floatx80_is_unsupported(b)) {
...
floatx80 CPU::floatx80_add(floatx80 a, floatx80 b, float_status_t *status)
{
    int aSign = extractFloatx80Sign(a);
...
floatx80 CPU::floatx80_sub(floatx80 a, floatx80 b, float_status_t *status)
{
    int aSign = extractFloatx80Sign(a);
    int bSign = extractFloatx80Sign(b);
    if (aSign == bSign)
...
floatx80 CPU::floatx80_mul(floatx80 a, floatx80 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int32_t  aExp, bExp, zExp;
    uint64_t aSig, bSig, zSig0, zSig1;
...
floatx80 CPU::floatx80_div(floatx80 a, floatx80 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int32_t  aExp, bExp, zExp;
    uint64_t aSig, bSig, zSig0, zSig1;
...
floatx80 CPU::floatx80_sqrt(floatx80 a, float_status_t *status)
{
    int      aSign;
    int32_t  aExp, zExp;
...
float128 CPU::floatx80_to_float128(floatx80 a, float_status_t *status)
{
    ...
    int      aSign = extractFloatx80Sign(a);
    if ((aExp == 0x7FFF) && (uint64_t)(aSig << 1))
        return CPU::commonNaNToFloat128(floatx80ToCommonNaN(a, status));
    shift128Right(aSig << 1, 0, 16, &zSig0, &zSig1);
    return packFloat128(aSign, aExp, zSig0, zSig1);
}
floatx80 CPU::float128_to_floatx80(float128 a, float_status_t *status)
{
    int32_t  aExp;
    ...
    if (aExp == 0x7FFF) {
        if (aSig0 | aSig1)
            return CPU::commonNaNToFloatx80(float128ToCommonNaN(a, status));
        return packFloatx80(aSign, 0x7FFF, 0x8000000000000000ULL);
    }
    if (aExp == 0) {
        if ((aSig0 | aSig1) == 0)
...
floatx80 CPU::floatx80_mul_with_float128(floatx80 a, float128 b, float_status_t *status)
{
    int32_t  aExp, bExp, zExp;
    ...
    zSign = aSign ^ bSign;
    if (aExp == 0x7FFF) {
        if ((uint64_t)(aSig << 1) || ((bExp == 0x7FFF) && (bSig0 | bSig1))) {
            floatx80 r = CPU::commonNaNToFloatx80(float128ToCommonNaN(b, status));
...
float128 CPU::addFloat128Sigs(float128 a, float128 b, int zSign, float_status_t *status)
{
    int32_t  aExp, bExp, zExp;
...
float128 CPU::subFloat128Sigs(float128 a, float128 b, int zSign, float_status_t *status)
{
    int32_t  aExp, bExp, zExp;
...
float128 CPU::float128_add(float128 a, float128 b, float_status_t *status)
{
    int aSign = extractFloat128Sign(a);
...
float128 CPU::float128_sub(float128 a, float128 b, float_status_t *status)
{
    int aSign = extractFloat128Sign(a);
    int bSign = extractFloat128Sign(b);
    if (aSign == bSign) {
...
float128 CPU::float128_mul(float128 a, float128 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int32_t  aExp, bExp, zExp;
...
float128 CPU::float128_div(float128 a, float128 b, float_status_t *status)
{
    int      aSign, bSign, zSign;
    int32_t  aExp, bExp, zExp;
    uint64_t aSig0, aSig1, bSig0, bSig1, zSig0, zSig1, zSig2;
...
float128 CPU::int64_to_float128(int64_t a)
{
    uint64_t zSig0, zSig1;
    if (a == 0)
...
int16_t CPU::floatx80_to_int16(floatx80 a, float_status_t *status)
{
    if (floatx80_is_unsupported(a)) {
        float_raise(status, float_flag_invalid);
...
int16_t CPU::floatx80_to_int16_round_to_zero(floatx80 a, float_status_t *status)
{
    if (floatx80_is_unsupported(a)) {
        float_raise(status, float_flag_invalid);
        return ((int16_t)0x8000);
...
floatx80 CPU::floatx80_extract(floatx80 *input, float_status_t *status)
{
    floatx80 a     = *input;
    uint64_t aSig  = extractFloatx80Frac(a);
    int32_t  aExp  = extractFloatx80Exp(a);
...
floatx80 CPU::floatx80_scale(floatx80 a, floatx80 b, float_status_t *status)
{
    int32_t  aExp, bExp;
    uint64_t aSig, bSig;
    if (floatx80_is_unsupported(a) || floatx80_is_unsupported(b)) {
...
float_class_t CPU::floatx80_class(floatx80 a)
{
    int32_t  aExp = extractFloatx80Exp(a);
    uint64_t aSig = extractFloatx80Frac(a);
    if (aExp == 0) {
...
int CPU::floatx80_compare_internal(floatx80 a, floatx80 b, int quiet, float_status_t *status)
{
...
float32 CPU::propagateFloat32NaN_two_args(float32 a, float32 b, float_status_t *status)
{
...
float64 CPU::propagateFloat64NaN_two_args(float64 a, float64 b, float_status_t *status)
{
...
floatx80 CPU::propagateFloatx80NaN_two_args(floatx80 a, floatx80 b, float_status_t *status)
{
...
float128 CPU::propagateFloat128NaN(float128 a, float128 b, float_status_t *status)
{
    int aIsNaN, aIsSignalingNaN, bIsNaN, bIsSignalingNaN;
...
int32_t CPU::roundAndPackInt32(int zSign, uint64_t exactAbsZ, float_status_t *status)
{
    int roundingMode     = get_float_rounding_mode(status);
...
int64_t CPU::roundAndPackInt64(int zSign, uint64_t absZ0, uint64_t absZ1, float_status_t *status)
{
    int64_t z;
    int     roundingMode     = get_float_rounding_mode(status);
    int     roundNearestEven = (roundingMode == float_round_nearest_even);
...
uint64_t CPU::roundAndPackUint64(int zSign, uint64_t absZ0, uint64_t absZ1, float_status_t *status)
{
    int roundingMode     = get_float_rounding_mode(status);
    int roundNearestEven = (roundingMode == float_round_nearest_even);
    int increment        = ((int64_t)absZ1 < 0);
...
void CPU::normalizeFloat16Subnormal(uint16_t aSig, int16_t *zExpPtr, uint16_t *zSigPtr)
{
    int shiftCount = countLeadingZeros16(aSig) - 5;
    *zSigPtr       = aSig << shiftCount;
    *zExpPtr       = 1 - shiftCount;
}
float16 CPU::roundAndPackFloat16(int zSign, int16_t zExp, uint16_t zSig, float_status_t *status)
{
...
void CPU::normalizeFloat32Subnormal(uint32_t aSig, int16_t *zExpPtr, uint32_t *zSigPtr)
{
    int shiftCount = countLeadingZeros32(aSig) - 8;
    *zSigPtr       = aSig << shiftCount;
    *zExpPtr       = 1 - shiftCount;
}
float32 CPU::roundAndPackFloat32(int zSign, int16_t zExp, uint32_t zSig, float_status_t *status)
{
...
float32 CPU::normalizeRoundAndPackFloat32(int zSign, int16_t zExp, uint32_t zSig, float_status_t *status)
{
    int shiftCount = countLeadingZeros32(zSig) - 1;
    return roundAndPackFloat32(zSign, zExp - shiftCount, zSig << shiftCount, status);
}
void CPU::normalizeFloat64Subnormal(uint64_t aSig, int16_t *zExpPtr, uint64_t *zSigPtr)
{
    int shiftCount = countLeadingZeros64(aSig) - 11;
    *zSigPtr       = aSig << shiftCount;
    *zExpPtr       = 1 - shiftCount;
}
float64 CPU::roundAndPackFloat64(int zSign, int16_t zExp, uint64_t zSig, float_status_t *status)
{
...
float64 CPU::normalizeRoundAndPackFloat64(int zSign, int16_t zExp, uint64_t zSig, float_status_t *status)
{
    int shiftCount = countLeadingZeros64(zSig) - 1;
    return roundAndPackFloat64(zSign, zExp - shiftCount, zSig << shiftCount, status);
}
void CPU::normalizeFloatx80Subnormal(uint64_t aSig, int32_t *zExpPtr, uint64_t *zSigPtr)
{
    int shiftCount = countLeadingZeros64(aSig);
    *zSigPtr       = aSig << shiftCount;
    *zExpPtr       = 1 - shiftCount;
}
floatx80 CPU::SoftFloatRoundAndPackFloatx80(int roundingPrecision, int zSign, int32_t zExp, uint64_t zSig0,
...
floatx80 CPU::roundAndPackFloatx80(int roundingPrecision, int zSign, int32_t zExp, uint64_t zSig0, uint64_t zSig1,
...
floatx80 CPU::normalizeRoundAndPackFloatx80(int roundingPrecision, int zSign, int32_t zExp, uint64_t zSig0,
                                            uint64_t zSig1, float_status_t *status)
{
    if (zSig0 == 0) {
        zSig0 = zSig1;
...
void CPU::normalizeFloat128Subnormal(uint64_t aSig0, uint64_t aSig1, int32_t *zExpPtr, uint64_t *zSig0Ptr,
                                     uint64_t *zSig1Ptr)
{
    int shiftCount;
    if (aSig0 == 0) {
...
float128 CPU::roundAndPackFloat128(int zSign, int32_t zExp, uint64_t zSig0, uint64_t zSig1, uint64_t zSig2,
                                   float_status_t *status)
{
...
float128 CPU::normalizeRoundAndPackFloat128(int zSign, int32_t zExp, uint64_t zSig0, uint64_t zSig1,
                                            float_status_t *status)
{
    uint64_t zSig2;
    if (zSig0 == 0) {
...
float32 CPU::propagateFloat32MulAddNaN(float32 a, float32 b, float32 c, float_status_t *status)
{
...
float64 CPU::propagateFloat64MulAddNaN(float64 a, float64 b, float64 c, float_status_t *status)
{
    int aIsNaN          = float64_is_nan(a);
    int bIsNaN          = float64_is_nan(b);
    int aIsSignalingNaN = float64_is_signaling_nan(a);
...
float32 CPU::float32_muladd(float32 a, float32 b, float32 c, int flags, float_status_t *status)
{
...
float64 CPU::float64_muladd(float64 a, float64 b, float64 c, int flags, float_status_t *status)
{
    int      aSign, bSign, cSign, zSign;
    int16_t  aExp, bExp, cExp, pExp, zExp;
...
float128 CPU::EvalPoly(float128 x, float128 *arr, int n, float_status_t *status)
{
    float128 r = arr[--n];
    do {
...
float128 CPU::EvenPoly(float128 x, float128 *arr, int n, float_status_t *status)
{
    return EvalPoly(float128_mul(x, x, status), arr, n, status);
}
float128 CPU::OddPoly(float128 x, float128 *arr, int n, float_status_t *status)
{
    return float128_mul(x, EvenPoly(x, arr, n, status), status);
}
float128 CPU::poly_ln(float128 x1, float_status_t *status)
{
    return OddPoly(x1, ln_arr, 9, status);
}
float128 CPU::poly_l2(float128 x, float_status_t *status)
{
...
float128 CPU::poly_l2p1(float128 x, float_status_t *status)
{
...
floatx80 CPU::fyl2x(floatx80 a, floatx80 b, float_status_t *status)
{
    if (floatx80_is_unsupported(a) || floatx80_is_unsupported(b)) {
    invalid:
        float_raise(status, float_flag_invalid);
...
floatx80 CPU::fyl2xp1(floatx80 a, floatx80 b, float_status_t *status)
{
    int32_t  aExp, bExp;
...
uint64_t CPU::argument_reduction_kernel(uint64_t aSig0, int Exp, uint64_t *zSig0, uint64_t *zSig1)
{
    uint64_t term0, term1, term2;
    uint64_t aSig1 = 0;
    shortShift128Left(aSig1, aSig0, Exp, &aSig1, &aSig0);
    uint64_t q = estimateDiv128To64(aSig1, aSig0, (0xc90fdaa22168c234ULL));
...
int CPU::reduce_trig_arg(int expDiff, int *zSign_input, uint64_t *aSig0_input, uint64_t *aSig1_input)
{
...
float128 CPU::poly_sin(float128 x, float_status_t *status)
{
    return OddPoly(x, sin_arr, 11, status);
}
float128 CPU::poly_cos(float128 x, float_status_t *status)
{
    return EvenPoly(x, cos_arr, 11, status);
}
void CPU::sincos_invalid(floatx80 *sin_a, floatx80 *cos_a, floatx80 a)
{
    if (sin_a)
        *sin_a = a;
    if (cos_a)
...
void CPU::sincos_tiny_argument(floatx80 *sin_a, floatx80 *cos_a, floatx80 a)
{
    if (sin_a)
        *sin_a = a;
    if (cos_a)
...
floatx80 CPU::sincos_approximation(int neg, float128 r, uint64_t quotient, float_status_t *status)
{
    if (quotient & 0x1) {
        r   = poly_cos(r, status);
        neg = 0;
...
int CPU::fsincos(floatx80 a, floatx80 *sin_a, floatx80 *cos_a, float_status_t *status)
{
...
int CPU::fsin(floatx80 *a, float_status_t *status)
{
    return fsincos(*a, a, 0, status);
}
int CPU::fcos(floatx80 *a, float_status_t *status)
{
    return fsincos(*a, 0, a, status);
}
int CPU::ftan(floatx80 *a_input, float_status_t *status)
{
    floatx80 a = *a_input;
    uint64_t aSig0, aSig1 = 0;
    int32_t  aExp, zExp, expDiff;
...
uint64_t CPU::remainder_kernel(uint64_t aSig0, uint64_t bSig, int expDiff, uint64_t *zSig0, uint64_t *zSig1)
{
    uint64_t term0, term1;
    uint64_t aSig1 = 0;
...
int CPU::do_fprem(floatx80 a, floatx80 b, floatx80 *r_input, uint64_t *q_input, int rounding_mode,
                  float_status_t *status)
{
    floatx80 r = *r_input;
    uint64_t q = *q_input;
...
int CPU::floatx80_ieee754_remainder(floatx80 a, floatx80 b, floatx80 *r, uint64_t *q, float_status_t *status)
{
    return do_fprem(a, b, r, q, float_round_nearest_even, status);
}
int CPU::floatx80_remainder(floatx80 a, floatx80 b, floatx80 *r, uint64_t *q, float_status_t *status)
{
    return do_fprem(a, b, r, q, float_round_to_zero, status);
}
float128 CPU::poly_atan(float128 x1, float_status_t *status)
{
    return OddPoly(x1, atan_arr, 11, status);
}
floatx80 CPU::fpatan(floatx80 a, floatx80 b, float_status_t *status)
{
    if (floatx80_is_unsupported(a) || floatx80_is_unsupported(b)) {
        float_raise(status, float_flag_invalid);
        return floatx80_default_nan;
...
float128 CPU::poly_exp(float128 x, float_status_t *status)
{
    float128 t = EvalPoly(x, exp_arr, 15, status);
    return float128_mul(t, x, status);
}
floatx80 CPU::f2xm1(floatx80 a, float_status_t *status)
{
